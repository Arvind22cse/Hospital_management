...
mongoose
  .connect(
    "mongodb+srv://arvindm22cse:31-Aug-04@hospital.jyifl.mongodb.net/?retryWrites=true&w=majority&appName=Hospital"
  )
  .then((result) => {
...
// const Attendance = require("./model/attendance.model.js");
// const Doctor = require("./model/doctor.model.js");
// // const faceapi = require('face-api.js/dist/face-api.node.js');
// // const client = twilio(
// //   process.env.TWILIO_ACCOUNT_SID,
// //   process.env.TWILIO_AUTH_TOKEN
// // );
